...
import IPeripheryPaymentsWithFee from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
