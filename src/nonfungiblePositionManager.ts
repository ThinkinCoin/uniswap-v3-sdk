...
import INonfungiblePositionManager from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
