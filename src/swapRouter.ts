...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@thinkincoin-libs/sdk-core'
...
import ISwapRouter from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
